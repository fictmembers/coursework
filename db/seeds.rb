...
hall_1 = Hall.create(hall_type: 'For smokers', capacity: 40, restaurant_id: rest_1.id)
hall_2 = Hall.create(hall_type: 'For non-smokers',capacity: 80, restaurant_id: rest_1.id)
hall_3 = Hall.create(hall_type: 'For non-smokers',capacity: 60, restaurant_id: rest_2.id)
hall_4 = Hall.create(hall_type: 'For visitors with children',capacity: 40, restaurant_id: rest_2.id)
