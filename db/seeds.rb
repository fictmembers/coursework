...
hall_1 = Hall.create(hall_type: 'Для курящих', lang: 'ru', restaurant_id: rest_1.id)
hall_2 = Hall.create(hall_type: 'Для некурящих', lang: 'ru', restaurant_id: rest_1.id)
hall_3 = Hall.create(hall_type: 'Для некуращих', lang: 'ru', restaurant_id: rest_2.id)
hall_4 = Hall.create(hall_type: 'Для посетителей с детьми', lang: 'ru', restaurant_id: rest_2.id)
