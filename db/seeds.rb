...
host_1 = Hostess.create(lastname: 'Jarvis', restaurant_id: rest_1.id, hall_id: hall_1.id)
host_2 = Hostess.create(lastname: 'Maria Hill', restaurant_id: rest_1.id, hall_id: hall_1.id)
host_3 = Hostess.create(lastname: 'Vision', restaurant_id: rest_2.id, hall_id: hall_3.id)
host_4 = Hostess.create(lastname: 'Ultron', restaurant_id: rest_2.id, hall_id: hall_4.id)
